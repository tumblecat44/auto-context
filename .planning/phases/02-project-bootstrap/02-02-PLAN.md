...
<task type="auto">
  ...
  <action>
Validate that both skills are properly structured for the Claude Code plugin system. This task verifies the integration between Phase 2 skills and the Phase 1 plugin scaffold.
